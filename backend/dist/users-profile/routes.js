...
exports.router.get('/me', auth_1.verifyUser, controller_1.getMe);
// PATCH /api/users/me - atualizar dados basicos (nome, email, telefone, endereco). Exige senha se email mudar.
exports.router.patch('/me', auth_1.verifyUser, (0, validate_1.validateBody)(users_schemas_1.profileUpdateSchema), controller_1.updateMe);
// POST /api/users/me/change-password - trocar senha via modal
exports.router.post('/me/change-password', auth_1.verifyUser, (0, validate_1.validateBody)(users_schemas_1.changePasswordSchema), controller_1.changeMyPassword);
...
exports.router.get('/', auth_1.verifyUser, auth_1.isAdmin, controller_1.adminListUsers);
// PATCH /api/users/:id/role - altera papel (apenas ROOT)
exports.router.patch('/:id/role', auth_1.verifyUser, auth_1.isRoot, controller_1.adminSetRole);
// POST /api/users/:id/password - redefine senha de um usuário (ADMIN/ROOT)
exports.router.post('/:id/password', auth_1.verifyUser, auth_1.isAdmin, controller_1.adminResetPassword);
// DELETE /api/users/:id - desativa usuário (admin/root)
exports.router.delete('/:id', auth_1.verifyUser, auth_1.isAdmin, controller_1.adminDeleteUser);
